...
<div class="container-fluid">
    ...
    <div class="container produit_style">
        <h2 class="produit_title_style text-center"><strong>{{$article->Titre}}</strong></h2>
        <div class="row">
                ...
                <div class="container ">
                    <center>
                        ...
                        <div class="xzoom-container">
                            <img src="{{ asset($article->Images.'/image_1.JPG') }}" class="xzoom image" xoriginal="{{ asset($article->Images.'/image_1.JPG') }}" alt="">
                            <div class="xzoom-thumbs">
                                <a href="{{ asset($article->Images.'/image_1.JPG') }}">
                                    <img class="xzoom-gallery" src="{{ asset($article->Images.'/image_1.JPG') }}" xpreview="<?php echo url('/'); ?>/images/Pack1/image_1.JPG" alt="">
                                </a>
                                <a href="{{ asset($article->Images.'/image_2.JPG') }}">
                                    <img class="xzoom-gallery" src="{{ asset($article->Images.'/image_2.JPG') }}" alt="">
                                </a>
                                <a href="{{ asset($article->Images.'/image_3.JPG') }}">
                                    <img class="xzoom-gallery" src="{{ asset($article->Images.'/image_3.JPG') }}" alt="">
                                </a>
                                <a href="{{ asset($article->Images.'/image_4.JPG') }}">
                                    <img class="xzoom-gallery" src="{{ asset($article->Images.'/image_4.JPG') }}" alt="">
                                </a>
            ...
            <div class="container col-lg-6 col-xl-7" style="vertical-align: center;">
                <div>
                    ...
                    <div>
                        <h1 class="produit_prix_style"><strong>1000 Dh</strong></h1>
                    </div>
					...
					<form action="{{ route('ajouterArticle', ['id'=>$article->id]) }}" method="POST" name="ajouterAuPanier" id="ajouterAuPanier">
                            ...
                            <div class="input-group-prepend">
								<label style="width: 100px; border: none;" class="form-control text-left" for="qty">Quantité:</label>
                                <div class="pro-quantity">
									<div class="pro-qty"><input class="form-control qtybtn" id="qty" name ="qty" type="text" max="{{$article->QteDeStock}}" value="1"></div>
								</div>
                            </div>
