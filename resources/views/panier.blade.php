                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    <td><img style="height: 50px; width: 50px;" src="{{ asset($article->attributes['image'].'/image_1.JPG') }}" /> </td>
                                    <td>{{ $article->name }}</td>
                                    <td>En stock</td>
                                    ...
                                    <td class="text-right"><form action="{{ route('supprimerArticle',['id'=>$article->id]) }}" method="Post">
                                        @csrf
