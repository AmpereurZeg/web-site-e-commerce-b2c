                    ...
                    <div class="col-lg-3 col-md-6 ">
                        <div class="char_item d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="char_content">
                                ...
                                <div class="char_subtitle">à partir de 1000 DH</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="char_item d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="char_content">
                                ...
                                <div class="char_subtitle">la meilleur</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @if ($article->Categorie === 'Kit')
                        @if ($article->New === 1)
                            <div class="card col-6 col-md-4 col-lg-3" id="newKit">
                                <a href="{{ route('voirArticle', ['refArticle' => $article->refArticle]) }}"><img
                                        src="{{ asset($article->Images . '/new.JPG') }}" class="card-img-top"
                                        alt="..."></a>
                                <div class="card-body">
                        ...
                        @else
                            <div class="card col-6 col-md-4 col-lg-3">
                                <a href="{{ route('voirArticle', ['refArticle' => $article->refArticle]) }}"><img
                                        src="{{ asset($article->Images . '/image_1.JPG') }}" class="card-img-top"
                                        alt="..."></a>
                                <div class="card-body">
                                    <h6 class="card-title text-center" style="height: 50px;">{{ $article->Titre }}</h6>
                                    <p><strong>{{ $article->Prix }} Dhs</strong></p>
