...
<body>
    <div class="super_container">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('checkout.store') }}" id="payment-form" class="my-4" method="POST">
                    @csrf
                    <div id="card-element">
                    ...
                    <button id="submit" class="btn  btn-success mt-4">Proceder au paiement ( {{ $panierTotal }} Dhs )</button>
                </form>
            </div>
        </div>
        <!-- Footer -->
