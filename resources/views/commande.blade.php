                                            ...
                                            <div class="custom_dropdown">
                                                <div class="custom_dropdown_list">
                                                    ...
                                                    <ul class="custom_list clc">
                                                        <li><a class="clc" href="#">toutes les catégories</a></li>
                                                        <li><a class="clc" href="#">Nouveautés</a></li>
                                                        <li><a class="clc" href="#">Kits électroniques</a></li>
                                                        <li><a class="clc" href="#">Cartes électroniques</a></li>
            ...
            <section>
                <div class="monCompteEcom  row">
                    <div class="monCompte col-lg-4 d-flex">
                        <nav>
                            <li class="monCompte-navigation-link"><a href="#">Tableau de bord</a></li>
                            <li class="monCompte-navigation-link" style="background-color: #fbfbfb"><a style="color:black;" href="#">Commandes</a></li>
                            <li class="monCompte-navigation-link"><a href="#">Adresses</a></li>
                            <li class="monCompte-navigation-link"><a href="#">Details du compte</a></li>
                            <li class="monCompte-navigation-link"><a href="#">Déconnexion</a></li>
                        </nav>
                    </div>
                    <div class = "mon-Compte col-lg-8">
                        <p>
                            Bonjour <strong>{{ Auth::user()->name }}</strong> (vous n’êtes pas <strong>{{ Auth::user()->name }})</strong> ?
                        </p>
                           <br>
                        <p>
                            À partir du tableau de bord de votre compte, vous pouvez visualiser vos 
                            <a href="#">commandes récentes</a>, gérer vos <a href="">adresses de livraison et de facturation</a> 
                            ainsi que <a href="#">changer votre mot de passe et les détails de votre compte</a>.
                        </p>
                    </div>
                </div>
            </section>
